				...
				<div class="row profile-row">
					...
					<div class="row">
						<div class="col-md-12" style="margin-top:15px;">
							<a href="SchoolDashboard.php"><button class="btn btn-default" type="button" name="cancel"
							style="font-family: Poppins, sans-serif;width: 120px;background: rgba(0,23,235,0);color: #0017eb;height: 45px;border-radius: 35px;margin: 0px;margin-right: 20px;font-weight: bold;border-width: 2px;border-color: #0017eb;">Cancel</button></a>
