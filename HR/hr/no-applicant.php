...
<body>
                        ...
                        <div class="container">
                            <div class="collapse navbar-collapse" id="navcol-1">
                                <ul class="navbar-nav me-auto">
                                    <li class="nav-item"><a class="nav-link active" data-bss-hover-animate="pulse" href="#" style="font-family: Poppins, sans-serif;color: #0017eb;"><i class="fa fa-paper-plane" style="padding-right: 5px;"></i>Applicant</a></li>
    ...
    <div id="main-content">
        <div class="loader-bear">
        <div class="loader"></div>
        <div class="text-center" style="color: rgb(0,0,0);font-size: 24px;font-family: Poppins, sans-serif;height: 200px;">
