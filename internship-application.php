...
<body style="color: rgb(0,0,0);"><nav class="navbar navbar-light navbar-expand bg-white  topbar static-top">
        ...
        <ul class="navbar-nav flex-nowrap ms-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><img class="border rounded-circle img-profile" src="School-Logo/<?php echo $_SESSION['schoolLogo']?>" /></a>
                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item" href="edit-profile.html"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i> Edit Profile</a><a class="dropdown-item" href="school-dashboard.php"><i class="fas fa-home fa-sm fa-fw me-2 text-gray-400" href="school-dashboard.php"></i>Dashboard</a>
    ...
    <div id="body">
        <div class="container">
            <form style="padding: 31px;" method="POST">
                <div id="ProgramAdviserInfo" style="padding: 40px 0px;">
                    ...
                    <div class="row d-xxl-flex justify-content-xxl-center align-items-xxl-center" id="name">
                        <div class="col" id="fname"><label class="form-label"><strong>First Name</strong></label>
                            <input class="form-control" name="advFname" type="text" style="height: 45px;border-radius: 35px;" placeholder="First Name" required="" onkeypress="return isVarchar(event)" ></div>
                        <div class="col" id="lname"><label class="form-label"><strong>Last Name</strong></label>
                            <input class="form-control" name="advLname" type="text" style="height: 45px;border-radius: 35px;" placeholder="Last Name" required="" onkeypress="return isVarchar(event)"></div>
                        <div class="col" id="blank"></div>
                    </div>
                    <div class="row" id="email">
                        <div class="col"><label class="form-label"><strong>Email</strong></label>
                            <input class="form-control" name="advEmail" type="email" style="height: 45px;border-radius: 35px;" placeholder="Email" required onkeypress="return validateEmail(event)"></div>
                ...
                <div id="InternshipInfo" style="padding: 40px 0px;">
                    ...
                    <div class="row">
                        <div class="col" id="program"><label class="form-label"><strong>Program</strong></label>
                            <input class="form-control" name="course" type="text" style="height: 45px;border-radius: 35px;" placeholder="Program" required="" onkeypress="return isVarchar(event)" ></div>
                        <div class="col" id="duration"><label class="form-label"><strong>Duration</strong></label>
                            <input class="form-control" name="duration" type="number" style="height: 45px;border-radius: 35px;" required="" min="100" max="500" onkeypress="return isNum(event)"></div>
                        <div class="col" id="blank-1"></div>
                    </div>
                </div>
                <div id="addStudent" style="padding: 40px 0px;"><div id="addStudent-1" style="padding: 40px 0px;"><h3><strong>Student Information</strong></h3><button class="btn btn-primary" type="button" style="background: #0017eb;height: 45px;border-radius: 35px;border-width: 2px;border-color: #0017eb;color: #ffffff;margin: 0px 12px;width: 122px;"><strong>Add</strong></button></div>
    <div class="row">
                ...
                <a class="btn btn-primary" name="discard" role="button" id="discard" style="background: rgba(0,23,235,0);width: 150px;height: 45px;border-radius: 35px;margin-right: 25px;color: #0017eb;border-width: 2px;" href="school-dashboard.php?page=1"><strong>Discard</strong></a>
                <input class="btn btn-primary" name="apply" type="submit" role="button" style="background: #0017eb;width: 150px;height: 45px;border-radius: 35px;margin-right: 25px;"></div>
            </form>
        </div>
    </div>
