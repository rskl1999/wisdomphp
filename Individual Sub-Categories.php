            ...
            <div class="container">
                <div class="row justify-content-center gap-3">
                    <div class="col-md-6 col-xxl-6" style="box-shadow: 0px 0px 14px 0px rgb(213,213,213);border-radius: 15px;padding: 2rem;margin: 1rem 0;width: 380px;">
                        <h1 style="font-size: 28px;font-weight: bold;">Key Roles</h1>
                        <ul>
                            <li  style = "margin: 10px 0; list-style-type:circle;">UI/UX Implementation</li>
                            <li  style = "margin: 10px 0; list-style-type:circle;">Web Development Technologies</li>
                            <li  style = "margin: 10px 0; list-style-type:circle;">Cross-Browser and Device Compatibility</li>
                            <li  style = "margin: 10px 0; list-style-type:circle;">Front-End Performance Optimization</li>
                            <li  style = "margin: 10px 0; list-style-type:circle;">Accessibility</li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-xxl-6" style="box-shadow: 0px 0px 14px 0px rgb(213,213,213);border-radius: 15px;padding: 2rem;margin: 1rem 0;width: 380px;">
                        <h1 style="font-size: 28px;font-weight: bold;">Key Roles</h1>
                        <ul>
                            <li style = "margin: 10px 0; list-style-type:circle;">Collaboration with Designers</li>
                            <li style = "margin: 10px 0; list-style-type:circle;">Integration with Backend</li>
                            <li style = "margin: 10px 0; list-style-type:circle;">Version Control and Code Collaboration</li>
                            <li style = "margin: 10px 0; list-style-type:circle;">Bug Fixing and Troubleshooting</li>
                            <li style = "margin: 10px 0; list-style-type:circle;">Continuous Learning and Growth</li>
                        </ul>
                    </div>
                </div>
            </div>
