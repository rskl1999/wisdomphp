...
<body>
    ...
    <div class="bootstrap_cards2">
        <div class="container py-5">
                ...
                $sql = "SELECT schoolID, SchoolName, address, schoolLogo FROM schooltbl WHERE schoolID IN (SELECT schoolID FROM applicanttbl)";
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <div class="card shadow-sm border-0 rounded">
                        <div class="card-body p-0">
                            <a href="transaction-history.php?id=<?php echo $rows['schoolID'] ?>">
                                <img src="School-Logo/<?php echo $rows['schoolLogo'];?>" alt="" class="w-100 card-img-top">
                            </a>
                            <div class="p-4">
                                <a href="transaction-history.php?id=<?php echo $rows['schoolID']?>"><h5 class="mb-0"><?php echo $rows['SchoolName'];?></h5></a>
                                <p class="small text-muted"><?php echo $rows['address'];?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            // Close the final row if it's still open
            if ($column_count % 4 != 0) {
                echo '</div>';
            }
            ?>
