...
<head>
   ...
   <link rel="stylesheet" href="calendar-assets/css/Navbar-With-Button-icons.css">
    ...
    <link rel="stylesheet" href="calendar-assets/css/tasks.css">
</head>
...
<body style="font-family: Poppins, sans-serif;">
                        ...
                        <div style="border-radius: 15px;box-shadow: 0px 0px 10px 0px rgba(82,82,82,0.18);padding: 25px;">
                            ...
                            <div class="row d-flex" style="border-radius: 15px;padding: 14px 7px;border: 1px solid rgb(218,218,218);">
                                ...
                                <div class="col-auto col-xxl-3 d-inline-flex flex-fill justify-content-center align-items-xxl-center">
                                    <h1 class="fw-semibold" id="renderedHours" style="font-size: 26px; margin-bottom: 0px;">00</h1>
                                    <h1 class="fw-normal" style="font-size: 15px; margin-bottom: 0px; margin-left: 3px;">hrs</h1>
                                </div>
                                <div class="col-auto col-xxl-3 d-inline-flex flex-fill justify-content-center align-items-xxl-center">
                                    <h1 class="fw-semibold" id="renderedMinutes" style="font-size: 26px; margin-bottom: 0px;">00</h1>
                        ...
                        <div id="total-rendered-div" style="border-radius: 15px;box-shadow: 0px 0px 10px 0px rgba(82,82,82,0.18);padding: 25px;margin-top: 1.5rem;">
                            <div>
                                <div class="row d-flex" style="padding: 14px 7px;">
                                    ...
                                    <div class="col-auto col-xxl-3 d-inline-flex flex-fill justify-content-center align-items-xxl-center">
                                        <h1 class="fw-semibold" style="font-size: 26px;margin-bottom: 0px;">00</h1>
                                        <h1 class="fw-normal" style="font-size: 15px;margin-bottom: 0px;margin-left: 3px;">hrs</h1>
                                    </div>
                                    <div class="col-auto col-xxl-3 d-inline-flex flex-fill justify-content-center align-items-xxl-center">
                                        <h1 class="fw-semibold" style="font-size: 26px;margin-bottom: 0px;">00</h1>
    ...
    <script src="calendar-assets/bootstrap/js/bootstrap.min.js"></script>
     ...
     <script src="calendar-assets/js/Daily-Tasks-Toggle.js"></script>
     <script src="calendar-assets/js/time.js"></script>
</body>
