        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div id="heading" style="padding-right: 24px;padding-left: 24px;">
                    <h5 style="color: rgb(0,0,0);font-weight: bold;">Daily Log</h5>
                </div>
                <div id="main-content">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12"><iframe src="https://docs.google.com/spreadsheets/d/1vulpiqQuQ-EUXfWBJhWM6iw6W7guaNS43aYg9PXG2E4/edit#gid=1311990711" width="100%" height="700px" style="border: none;overflow: hidden;" scrolling="no" frameborder="0" allowTransparency="true"></iframe></div>
                        </div>
                    </div>
                </div>
            </div>
